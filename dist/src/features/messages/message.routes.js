...
router.post('/groups/:id/messages', auth_middleware_1.authenticateVerified, (0, validators_1.validateRequest)(message_validator_1.sendMessageValidator), message_controller_1.messageController.sendMessage);
...
router.post('/messages/:id/react', auth_middleware_1.authenticate, (0, validators_1.validateRequest)([
...
]), message_controller_1.messageController.addReaction);
router.delete('/messages/:id/react', auth_middleware_1.authenticate, (0, validators_1.validateRequest)([
    require('express-validator').body('emoji')
        .exists().withMessage('emoji is required')
        .isString().isLength({ min: 1, max: 10 }).withMessage('Invalid emoji'),
]), message_controller_1.messageController.removeReaction);
