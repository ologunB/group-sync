...
exports.generateUniqueGroupSlug = generateUniqueGroupSlug;
 ...
 */
async function generateUniqueGroupSlug(name) {
    ...
    for (let i = 2; i <= 10; i++) {
        ...
        const taken = await connection_1.prisma.group.findUnique({
    ...
    throw new Error(`Could not generate a unique slug for "${name}" after 10 attempts. ` +
